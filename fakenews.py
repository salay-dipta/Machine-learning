...
import numpy as np
import pandas as pd
df = pd.read_csv('C:/Users/ASUS/Desktop/Fake_News_Detection/fake_or_real_news.csv')
#print(df.head())
...
X_train, X_test, y_train, y_test = train_test_split(X_data_full_tfidf, df['title'], test_size=0.2 , random_state = 52)
